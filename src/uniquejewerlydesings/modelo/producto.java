...
public class producto extends proveedor {
    ...
    public producto(int id_producto, int calculo_utilidad, String descripcion, Date fecha, int cantidad, double peso_metal, String tipo_metal, double precio_unitario, double precio_total, int id_proveedor, int id_persona, String cedula, String nombres, String direccion, String telefono, String correo) {
